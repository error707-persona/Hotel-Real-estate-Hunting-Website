...
<input type="radio" name="gender" id="rd" required>&nbsp;&nbsp;<span id="but">Male</span>&nbsp;&nbsp;&nbsp;   <input type="radio" name="gender" id="rd">&nbsp;&nbsp;&nbsp;<span id="but">Female</span><br>
...
<br><br>
Account already exists try loging in!
