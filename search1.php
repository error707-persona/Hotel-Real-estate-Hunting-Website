...
<html lang="en">
<?php
include('databasesqlconnection.php');
?>
<head>
    <meta charset="UTF-8">
...
$property=$collection->find(
  ['location'=>$_POST['location']],['property_type'=>$_POST['property']],['room'=>$_POST['room']],['bathroom'=>$_POST['bathroom']],
 ['projection'=>['_id'=>0,'property'=>1]]
 );
$room=$collection->find( 
  ['location'=>$_POST['location']],['property_type'=>$_POST['property']],['room'=>$_POST['room']],['bathroom'=>$_POST['bathroom']],
 ['projection'=>['_id'=>0,'room'=>1]]
 );
$bathroon=$collection->find( 
  ['location'=>$_POST['location']],['property_type'=>$_POST['property']],['room'=>$_POST['room']],['bathroom'=>$_POST['bathroom']],
 ['projection'=>['_id'=>0,'bathroom'=>1]]
 
);
$f=$collection->getFindCount;
}
-->
                    <form class="filter-form" method="search">
                        <div class="location">
                            <p>Location</p>
							<?php
							$select="SELECT DISTINCT(location) from property where product_status='1' order by product_id DESC";
...
{							 
 ...
 <select class="filter-location">
                                ...
                                <option value="">Tathawade</option>
                                <option value="">Undri</option>
...
?>
                        ...
                        <div class="price-range">
                            ...
                            <div class="range-slider">
                                <div id="slider-range">
								<input type="hidden" id="hidden-minimum-price" value="0"/>
								<input type="hidden" id="hidden-maximum-price" value="65000"/>
								<p id="price-show">1000-65000</p>
	...
	$(document).ready(function(){
		...
		function filter_data()
		{
			...
			var miniimum_price=$('#hidden_minimum_price').val();
			var maximum_price=('#hidden_maximum_price').val();
            var loc=get_filter('location');
			var property=get_filter('type');
			var bedroom=get_filter('room');
			var bathroom=get_filter('bathroom');
			$.ajax({
				url:"fetch_data.php",
				method:"POST";
		...
		{
			var filter_name+':checked').each(function(){
				filter.push($(this).val());
				
			});
			return filter;
		}
		$('.common_selector').clicked(function(){
			filter_data();
                        ...
                        <div class="room-text">
                            <div class="room-details">
                                <div class="room-title">
                                    <h5></h5>
                                    <a href="#"><i class="flaticon-placeholder"></i> <span><?php $loc;?></span></a>
